    ...
    return (
        <div className={`ceritaPage w-screen h-screen absolute bottom-0 overflow-hidden ${props.pagenum===1? "fadeIn z-20" : "fadeOut z-10"}`}>
          ...
          <div className="absolute bottom-10 w-full px-10 flex flex-row justify-between">
            ...
            <div className={`feedback feedbackCorrect text-cWhite bg-cBlack absolute top-16 -right-96 z-40 rounded-lg z-30 w-96 px-3 py-3 text-lg ${answer==correctAnswer && currCaption==maxCaption ? 'visible' : ''} `}>Selamat kamu mendapatkan 50 Koin!</div>
