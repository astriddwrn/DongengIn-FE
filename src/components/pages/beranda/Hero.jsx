    ...
    return (
      <>
        <div className="hero h-screen w-full relative">
          ...
          <img className="-bottom-72 absolute w-full z-0" src={Mountain2} alt="" />
          <div className="text-cont top-52 absolute right-36 z-50 w-4/12">
            ...
            <div className="text-2xl tracking-widest w-11/12 leading-9">Jelajahi cerita dongeng yang akan membawamu kedalam dunia khayalan</div>
