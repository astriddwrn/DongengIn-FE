...
const YukMasuk = () => {
    ...
    return (
        <div className="yukmasuk bg-cLightBlue w-full py-20 flex flex-col items-center">
            ...
            <Link to="masuk" className="bg-cPurple tracking-widest leading-relaxed rounded-full p-3 w-40 text-center text-cWhite mx-auto mt-10 font-extrabold cursor-pointer btnPurple">Yuk Masuk!</Link>
        </div>
    );
